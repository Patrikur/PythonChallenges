...
def check_winner(game):
    ...
    for row in range(0, 6):
        for col in range(0, 7):
            try:
                if game[row][col] == "O" and game[row][col+1] == "O" and game[row][col+2] == "O" and game[row][col+3] == "O":
                    return "O"
            except:
                pass

            try:
                if game[row][col] == "X" and game[row][col+1] == "X" and game[row][col+2] == "X" and game[row][col+3] == "X":
                    return "X"
            except:
                pass

            try:
                if game[row][col] == "O" and game[row+1][col] == "O" and game[row+2][col] == "O" and game[row+3][col] == "O":
                    return "O"
            except:
                pass

            try:
                if game[row][col] == "O" and game[row+1][col+1] == "O" and game[row+2][col+2] == "O" and game[row+3][col+3] == "O":
                    return "O"
            except:
                pass
            ...
            try:
                if game[row][col] == "X" and game[row+1][col] == "X" and game[row+2][col] == "X" and game[row+3][col] == "X":
                    return "X"
            except:
                pass

            try:
                if game[row][col] == "X" and game[row+1][col+1] == "X" and game[row+2][col+2] == "X" and game[row+3][col+3] == "X":
                    return "X"
            except:
                pass
